...
```bash
python test_chat.py --list                # 查看 NPC 列表
python test_chat.py --single "你好"       # 单 NPC 对话
python test_chat.py --agent "设计登录页"  # 多 Agent 协作
python test_chat.py --stream "你好"       # 流式响应（需先启动服务器）
```
